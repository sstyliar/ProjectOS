...
// }multiPlayer;
void diff(monster m,boss b,int lvl)
...
void mainController(const char *maze, int width, int height,char **temp_maze, human h1,monster m1,boss b1,int file_num){
 ...
 //Player1 stats
   ...
   sprintf(accuracy,"%d",h1.stats.accuracy);
...
int main(int argc,char *argv[]) {
   int o,k=0;
   printf("Welcome to METARXIDIAPOKSO\n");
   printf("-------------------------------\n");
 ...
 { system("clear");
   printf("You glupi kurwa chose between register,if you are polak nub,and login if you are challenger:\n");
   printf("1.register\n");
   printf("2.log in\n");
   printf("3.exit(you NUB!)\n");
   scanf("%d",&o);
   while(o!=1 && o!=2 && o!=3)
  {
    printf("You polak nub had 1 job!\n");
